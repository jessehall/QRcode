(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.QR = factory());
    ...
    /* src/QR.svelte generated by Svelte v3.24.0 */

    function add_css() {
    	var style = element("style");
    	style.id = "svelte-t0ppj9-style";
    	style.textContent = ".qr.svelte-t0ppj9.svelte-t0ppj9{display:block;shape-rendering:crispEdges;transform:translateZ(0)}.qr.svelte-t0ppj9 rect.svelte-t0ppj9{fill:var(--qr-color, 'currentColor')}";
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			toggle_class(rect, "svelte-t0ppj9", true);
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(svg, "class", "qr svelte-t0ppj9");
    ...
    class QR extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-t0ppj9-style")) add_css();
    		init(this, options, instance, create_fragment, safe_not_equal, { text: 2, level: 3, version: 4 });
    	}
    }
